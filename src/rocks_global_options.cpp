...
namespace mongo {
    ...
    Status RocksGlobalOptions::add(moe::OptionSection* options) {
        ...
        rocksOptions
            .addOptionChaining("storage.rocksdb.cacheSizeGB", "rocksdbCacheSizeGB",
                moe::Int,
                "maximum amount of memory to allocate for cache; "
                "defaults to 30%% of physical RAM",
                {}, {}, 
                moe::OptionSection::OptionParserUsageType::IDLAutoGeneratedCode);
        rocksOptions
            .addOptionChaining("storage.rocksdb.compression", "rocksdbCompression",
                moe::String,
        ...
        rocksOptions
            .addOptionChaining("storage.rocksdb.configString", "rocksdbConfigString",
                moe::String,
