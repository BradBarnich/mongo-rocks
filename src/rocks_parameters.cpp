...
void RocksRateLimiterServerParameter::append(OperationContext* opCtx,
                                             BSONObjBuilder& b,
...
void RocksBackupServerParameter::append(OperationContext* opCtx,
                                        BSONObjBuilder& b,
                                        const std::string& name) {
    b.append(name, "");
}
...
void RocksCompactServerParameter::append(OperationContext* opCtx,
                                         BSONObjBuilder& b,
                                         const std::string& name) {
    b.append(name, "");
}
...
void RocksCacheSizeParameter::append(OperationContext* opCtx,
                                     BSONObjBuilder& b,
                                     const std::string& name) {
...
void RocksOptionsParameter::append(OperationContext* opCtx,
                                   BSONObjBuilder& b,
                                   const std::string& name) {
